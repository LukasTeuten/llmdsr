...
const models = modelList as any[];
  ...
  return (
    ...
    >
{models.length === 0 ? (
  <div className="fieldset" style={{ borderColor: "rgba(255,196,77,0.45)" }}>
    <div style={{ fontWeight: 800, marginBottom: 6 }}>Hinweis</div>
    <div className="small">
      Es konnten keine Modelldaten als Liste geladen werden. Prüfe bitte, ob <code>/models.json</code> im Deploy enthalten ist
      und ob das Format <code>[...]</code> oder <code>{'{'} "models": [...] {'}'}</code> ist.
    </div>
  </div>
) : null}
